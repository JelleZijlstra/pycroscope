...
- Keep relation memoization from reusing stale results for mutable runtime values (like mutated functions) and from suppressing repeated `TypeForm` annotation diagnostics.
