...
- Improve class-object resolution across union/intersection/annotated values in core name checking, reducing false negatives in protocol-instantiation, enum-base, and attribute-target checks.
