...
an AST with inferred :class:`pycroscope.value.Value` objects in `.inferred_value`
attributes.
...
def annotate_code(
    ...
    *,
    ...
    :param visitor_cls: Pass a subclass of :class:`pycroscope.name_check_visitor.NameCheckVisitor`
                        to customize pycroscope behavior.
    :type visitor_cls: Type[NameCheckVisitor]

    :param dump: If True, the annotated AST is printed out.
    :type dump: bool

    :param show_errors: If True, errors from pycroscope are printed.
