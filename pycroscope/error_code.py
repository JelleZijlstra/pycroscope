...
ErrorCode = ErrorRegistry(
    [
        ...
        Error("invalid_self_usage", "Invalid use of Self in an annotation"),
        Error("invalid_paramspec_usage", "Invalid use of ParamSpec"),
        Error("invalid_qualifier", "Invalid use of an annotation qualifier"),
        Error("invalid_typeddict", "Invalid TypedDict definition"),
        Error("invalid_namedtuple", "Invalid NamedTuple definition"),
        Error("invalid_final", "Invalid use of Final or @final"),
...
def register_error_code(name: str, description: str) -> Error:
    ...
    type(
        name,
        (pycroscope.options.BooleanOption,),
        {
            "__doc__": description,
            "name": name,
            "default_value": True,
