...
from .asynq_tests import PropertyObject, autogenerated, l0cached_async_fn, proxied_fn
...
def test_get_task_cls():
    assert _get_task_cls(proxied_fn) is asynq.FutureBase
    assert _get_task_cls(autogenerated) is asynq.AsyncTask
    assert _get_task_cls(l0cached_async_fn) is asynq.AsyncTask
    assert _get_task_cls(PropertyObject(1).l0cached_async_method) is asynq.AsyncTask
